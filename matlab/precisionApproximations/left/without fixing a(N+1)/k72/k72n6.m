...
f = fopen('D:\repositories\OpenFFD\testOpenFFD\Y_k3.5.txt','r');
Y = fscanf(f, '%f');
fclose(f);

X = log(exp(Y)-1); 

f = fopen('D:\repositories\OpenFFD\testOpenFFD\I_base_k3.5.txt','r');
I_base = fscanf(f, '%f');
fclose(f);
...
f = fopen('D:\repositories\OpenFFD\testOpenFFD\I_add_k3.5.txt','r');
I_add = fscanf(f,'%f');
fclose(f);
